...
class FragmentScreenTaker:
    # def __init__(self, left=940, top=115, width=200, height=200): small
    def __init__(self, left=995, top=170, width=90, height=90):
        """
...
image = radar_status.load_image(img_byte_arr)

dots = radar_status.count_red_dots(image)
print("dots", dots)

res = radar_status.determine_direction_based_on_rectangle(image)
